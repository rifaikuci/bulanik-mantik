...
$dosyaDegerler = fopen("../../netting/fahp/alt2.csv", 'r');
$icerikDegerler = fread($dosyaDegerler, filesize("../../netting/fahp/alt2.csv"));
    ...
    <div class="card">
        <div class="card-body">
            ...
            <table id="example2" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <th style="text-align: center; ">
                        Geometik D.
                            ...
                            $dosya = fopen("../../netting/fahp/alt3.csv", 'w+');
                            fwrite($dosya, $deger);
                            fclose($dosya);

                            $dosyaAlternatif = fopen("../../netting/fahp/alt3.csv", 'r');
                            $icerikAlternatif = fread($dosyaAlternatif, filesize("../../netting/fahp/alt3.csv"));
                ...
                $dosya = fopen("../../netting/fahp/alt4.csv", 'w+');
                fwrite($dosya, $yazilacak);
                fclose($dosya); ?>
                <div class="card-footer">
                    <div>
                        <a href="../alt3/?id=<?php echo $_GET['id']?>" class="btn btn-info float-right">İlerle</a>
